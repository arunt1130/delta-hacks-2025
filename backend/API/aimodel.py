...
def chat(distance, closest_wildfire, percent_danger):
    # Generate the response
    message = (f"Based off the information I will present, give me plausible solutions on what to"
           ...
           "Make sure that you mention specific values that I have provided during the prompt. Make sure you respond in ONLY 3 to 4 bullet points, all spaced out on each line WITHOUT USING \n")
